...
class CreateTableDesteteFinalizacion extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('formulario_destete_finalizacion', function (Blueprint $table) 
        {
            $table->increments('id'); 
    ...
    {
        Schema::drop('formulario_destete_finalizacion');
    }
}
