...
@section('content') 
	<title> Consultar Procesos | Cercafe</title> 
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" />
	<div class="container-fluid col-md-12">
		<h2><strong style=" color: #df0101;">Consultar procesos: </strong></h2>
        <br/>
        <p>Los siguientes son los <strong>formularios designados</strong> para la compilación de la información semanal de cada una de las granjas. <strong>Diligencielos de forma correcta:</strong></p>
		<div class="col-xs-12 col-md-4 ">
			<div class="thumbnail">
				<a href="{{ route('admin.precebos.index') }}" data-toggle="tooltip" data-placement="top" title="Precebo">{{Html::image('media/img/precebo2.0.jpg', 'im_precebo')}}</a>
				<div class="caption">
					<center>
		...
		<div class="col-xs-12 col-md-4 ">
			<div class="thumbnail">
				<a href="{{ route('admin.cebas.index') }}" data-toggle="tooltip" data-placement="top" title="Ceba">{{Html::image('media/img/ceba2.0.jpg', 'im_ceba')}}</a>
				<div class="caption">
					<center>
		...
		<div class=" col-xs-12 col-md-4 ">
			<div class="thumbnail">
				<a href="{{ route('admin.desteteFinalizacion.index') }}" data-toggle="tooltip" data-placement="top" title="Destete Finalizacion">{{Html::image('media/img/destete2.0.jpg', 'im_destete_finalizacion')}}</a>
				<div class="caption">
					<center>
	...
	<div class="container-fluid col-md-12">
		<div class="col-xs-12 col-md-6">
			<div class="thumbnail">
				<a href="{{ route('admin.reporteMortalidad.index') }}" data-toggle="tooltip" data-placement="top" title="Mortalidad Precebo Ceba">{{Html::image('media/img/mortalidad2.0.jpg', 'im_mortalidad')}}</a>
				<div class="caption">
					<center>
		...
		<div class="col-xs-12 col-md-6">
			<div class="thumbnail">
				<a href="{{ route('admin.destetosSemana.index') }}" data-toggle="tooltip" data-placement="top" title="Destete Semana">{{Html::image('media/img/semana2.0.jpg', 'im_destete')}}</a>
				<div class="caption">
					<center>
