...
<p><strong>Registro: </strong> <span style="color: #df0101;">Ceba</span></p>
<table class="normal" summary="Tabla genérica">
	@foreach($ceba_solicitada as $ceba)
		<tr>
			<td><strong>Fecha Inicial:</strong> </td>
			<td class="datos">{{$ceba['fecha_ingreso_lote']}}</td>
		</tr>
		<tr>
			<td><strong>Fecha Final:</strong> </td>
			<td class="datos">{{$ceba['fecha_salida_lote']}}</td>
		</tr>
		<tr>
			<td><strong>Numero Inicial:</strong> </td>
			<td class="datos">{{$ceba['inic']}}</td>
		</tr>
		<tr>
			<td><strong>Numero Final:</strong> </td>
			<td class="datos">{{$ceba['cant_final_cerdos']}}</td>
		</tr>
		<tr>
			<td><strong>Porcentaje de Mortalidad:</strong> </td>
			<td class="datos">{{$ceba['por_mortalidad']}}%</td>
		</tr>
		<tr>
			<td><strong>Dias:</strong> </td>
			<td class="datos">{{$ceba['dias']}}</td>
		</tr>
		<tr>
			<td><strong>Peso Promedio Inicial:</strong> </td>
			<td class="datos">{{$ceba['peso_promedio_ingresado']}}</td>
		</tr>
		<tr>
			<td><strong>Peso Promedio Final:</strong> </td>
			<td class="datos">{{$ceba['peso_promedio_vendido']}}</td>
		</tr>
		<tr>
			<td><strong>Consumo Promedio:</strong> </td>
			<td class="datos">{{$ceba['cons_promedio_ini']}}</td>
		</tr>
		<tr>
			<td><strong>Consumo Promedio Día:</strong> </td>
			<td class="datos">{{$ceba['cons_promedio_dia_ini']}}</td>
		</tr>
		<tr>
			<td><strong>Ganancia Promedio:</strong> </td>
			<td class="datos">{{$ceba['ato_promedio_ini']}}</td>
		</tr>
		<tr>
			<td><strong>Ganancia Promedio Día:</strong> </td>
			<td class="datos">{{$ceba['ato_promedio_fin']}}</td>
		</tr>
		<tr>
			<td><strong>Conversion Real:</strong> </td>
			<td class="datos">{{$ceba['conversion_ini']}}</td>
		</tr>
		<tr>
			<td><strong>Consumo Promedio con Mortalidad:</strong> </td>
			<td class="datos">{{$ceba['consumo_promedio_lote']}}</td>
		</tr>
		<tr>
			<td><strong>Consumo Promedio Día con Mortalidad:</strong> </td>
			<td class="datos">{{$ceba['consumo_promedio_lote_dias']}}</td>
		</tr>
		
		<tr>
			<td><strong>Ganancia Promedio con Mortalidad:</strong> </td>
			<td class="datos">{{$ceba['ato_promedio_dia_ini']}}</td>
		</tr>
		
		<tr>
			<td><strong>Ganancia Promedio Día con Mortalidad:</strong> </td>
			<td class="datos">{{$ceba['ato_promedio_dia_fin']}}</td>
		</tr>
		
		<tr>
			<td><strong>Conversion Real con Mortalidad:</strong> </td>
			<td class="datos">{{$ceba['conversion_fin']}}</td>
		</tr>
	@endforeach
</table>